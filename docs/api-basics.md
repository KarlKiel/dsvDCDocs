...
The vDC-API is built on **Google Protocol Buffers** (protobuf), providing:
...
All communication uses Protocol Buffer messages with a simple framing protocol:
...
2. **Message Payload:** Serialized Protocol Buffer message
