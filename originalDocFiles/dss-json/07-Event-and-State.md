...
|---|---|---|
| name | identifierstringforevent | Mandatory |
| parameter | listofkey=valuepairs,seperatedwithsemicolons | Optional |
...
| Parameter | Description | Remarks |
|---|---|---|
| name | identifierforthestate | mandatory |
| value | newvalue | mandatory |
| addon | specifytheownerofthestate | optional |
