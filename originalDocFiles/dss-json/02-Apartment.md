...
| name | identifierstringfortheinstallation |
|---|---|
...
|---|---|---|
| dsid | dSIDofthedigitalSTROM-Meter | Mandatory |
...
| Parameter | Description | Remarks |
|---|---|---|
| icon | stringid,lastcharacterd/nindicatesday/night | Mandatory |
| condition | stringid,seehttps://openweathermap.org/weather-conditions | Mandatory |
| service | Serviceid | Optional |
| ts | stringtimestamp | Optional |
...
| Parameter | Description | Remarks |
|---|---|---|
| time | ISO8601timewhenthedeviceswereregistered | Mandatory |
...
| Parameter | Description | Remarks |
|---|---|---|
| lang | LocaleCodebasedonLanguage_Regionpattern,e.g. en_EN,de_DE |  |
